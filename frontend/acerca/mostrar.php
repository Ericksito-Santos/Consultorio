...
<head>
    ...
    <title>Cal y mayor | Acerca de</title>
</head>
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="../admin/escritorio.php" ><i class='bx bxs-dashboard icon' ></i> Panael Principal</a></li>
...
<div class="images-container">
            <div class="flex-card-image">
                <img src="../../backend/img/subidas/44227.jpg" />
              </div>
