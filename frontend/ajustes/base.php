...
<head>
    ...
    <title>Cal y Mayor |Bases de datos</title>
</head>
<body>
        ...
        <li class="flex-card-listitem">
            <div class="flex-card">
              <div class="flex-card-image">
                <img src="../../backend/img/subidas/714053.jpg" />
              </div>
              <div class="flex-card-content">
                <a href="../../backend/img/subidas/<?php echo $e->base; ?>" class="flex-card-button" Descacar>Descargar</a>
              </div>
            </div>
        </li>
<?php endforeach; ?>
