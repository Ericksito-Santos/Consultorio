...
<head>
    ...
    <title>Cal y mayor | Panel administrativo</title>
</head>
<body>
    
    <!-- SIDEBAR -->
    <section id="sidebar">
        <a href="escritorio.php" class="brand"><i class='bx bxs-heart icon'></i> Gestión De La Información</a>
        <ul class="side-menu">
            <li><a href="escritorio.php" class="active"><i class='bx bxs-dashboard icon' ></i> Panel De Control</a></li>
            ...
            <li>
                <a href="#"><i class='bx bxs-briefcase icon' ></i> Doctores <i class='bx bx-chevron-right icon-right' ></i></a>
                <ul class="side-dropdown">
                    <li><a href="../medicos/mostrar.php">Lista de Doctores</a></li>
                    <li><a href="../medicos/historial.php">Historial de los Doctores</a></li>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
    ...
    <div class="alert">
      <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
      <strong>peligro!</strong> No hay datos.
    </div>
    <?php endif; ?>
