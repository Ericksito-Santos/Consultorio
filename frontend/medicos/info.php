...
<head>
    ...
    <title>Cal y mayor | Información del médico</title>
</head>
<body>
    ...
    <section id="sidebar">
        ...
        <a href="../admin/escritorio.php" class="brand"><i class='bx bxs-heart icon'></i> Gestión de la Información</a>
        <ul class="side-menu">
            <li><a href="../admin/escritorio.php" ><i class='bx bxs-dashboard icon' ></i>  Panel de Control</a></li>
            <li class="divider" data-text="Inicio">Panel</li>
            <li>
            ...
            <li>
                <a href="#" class="active"><i class='bx bxs-briefcase icon' ></i> Doctores <i class='bx bx-chevron-right icon-right' ></i></a>
                <ul class="side-dropdown">
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../medicos/mostrar.php">Listado de los Doctores</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Información del Doctor</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
   ...
   <br>
    ...
    <label for="psw"><b>Teléfono del Doctor</b></label><span class="badge-warning">*</span>
    <input type="text" value="<?php echo $d->phd; ?>"  maxlength="13" readonly placeholder="ejm: +51 999 888 111" name="telme" required>

    <label for="psw"><b>Fecha de nacimiento del doctor</b></label><span class="badge-warning">*</span>
    <input type="date" value="<?php echo $d->nacd; ?>" name="cumme" readonly required>

    <label for="psw"><b>Correo  del Doctor</b></label><span class="badge-warning">*</span>
    <input type="text" value="<?php echo $d->corr; ?>" name="corr" readonly required>

     <label for="psw"><b>Usuario  del Doctor</b></label><span class="badge-warning">*</span>
