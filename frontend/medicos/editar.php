...
<head>
    ...
    <title>Cal y mayor | Actualizar del médico</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../medicos/mostrar.php">Listado de los doctor</a></li>
                <li class="divider">></li>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
   ...
   <br>
    ...
    <label for="psw"><b>Cédula del Doctor</b></label><span class="badge-warning">*</span>
    ...
    <select required name="doces"  id="espm">
        ...
        <option value="Rehabilitación">Ortodoncia</option>
    ...
    <label for="psw"><b>Nacimiento del Doctor</b></label><span class="badge-warning">*</span>
