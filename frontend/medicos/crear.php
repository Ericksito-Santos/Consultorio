...
<head>
    ...
    <title>Cal y mayor | Crear perfil del del médico</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Crear perfil del del Doctores</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
   ...
   <br>
    ...
    <label for="psw"><b>Nombre y apellidos del Doctor</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Correo electrónico del Doctor</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Contraseña del Doctor</b></label><span class="badge-warning">*</span>
    <input type="password"  name="pwdm"  required>

    <label for="psw"><b>Rol del Doctor</b></label><span class="badge-warning">*</span>
