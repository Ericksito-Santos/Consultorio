...
<head>
    ...
    <title>Cal y mayor | Historial de los médicos</title>
</head>
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#" class="active"><i class='bx bxs-briefcase icon' ></i> Doctor <i class='bx bx-chevron-right icon-right' ></i></a>
                <ul class="side-dropdown">
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Historial de los Doctores</a></li>
            </ul>
