...
$pdf->Cell(50,$ancho, utf8_decode('CAL Y MAYOR-ACOSTA'),'B',0,'C');
$pdf->Ln(6);
$pdf->SetFont('Arial','',8);   
...
$pdf->Cell(30, 5, utf8_decode($row['nompa']),0,0,'C',0);
$pdf->Cell(35, 5, utf8_decode($row['nodoc'] ."\n".  $row['apdoc']),0,0,'C',0);
$pdf->Cell(40, 5,'MXN/'.($row['monto']),0,1,'C',0);
