    ...
    function Header()
{
    ...
    $this->Text(65, 5, utf8_decode('CAL Y MAYOR-ACOSTA ESPECIALISTAS DENTALES'));
    $this->Text(75, 20, utf8_decode('Dr(a): '.$_SESSION['name'].''));
    $this->Text(75,25, utf8_decode('Tel: +52 968 129 2388'));
...
$pdf->SetFont('Arial','B',10);
    ...
    $pdf->Cell(70, 7, utf8_decode('Receta instrucciones '),1,0,'C',0);
...
//// Apartir de aqui esta la tabla con los subtotales y totales
        ...
        $pdf->Cell(60,6,'MXN/$'.($row['monto']),'1',1,'R');
        $pdf->setX(95);
