...
<head>
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="../../backend/img/subidas/215961.jpg">
 ...
 <!-- FullCalendar -->
    ...
    <title>Cal y mayor| Calendario de las citas</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                <li><a href="../admin/escritorio.php">panel</a></li>
                <li class="divider">></li>
  ...
  $(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
      ...
      eventDrop: function(event, delta, revertFunc) { // si cambio de posición

        edit(event);

      },
      eventResize: function(event,dayDelta,minuteDelta,revertFunc) { // si cambio de longitud
