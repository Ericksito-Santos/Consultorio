    ...
    function Header()
{
    ...
    $this->setY(12);
    $this->setX(10);
    $this->Image('../../backend/img/subidas/714053.jpg',25,5,33);
    $this->SetFont('times', 'B', 13);
    $this->Text(75, 15, utf8_decode('CAL Y MAYOR-ACOSTA'));
    $this->Text(75, 20, utf8_decode('Dr(a): '.$_SESSION['name'].''));
    $this->Text(75,25, utf8_decode('Tel: 968 129 2388    '));
    $this->Text(75,30, utf8_decode('smaq1994@gmail.com'));
...
// Agregamos los Consulta del paciente
    ...
    $this->SetFont('Arial','B',10);    
    $this->Text(10,164, utf8_decode('CONSULTA DEL PACIENTE'));
    $this->Ln(50);
    


     // Agregamos los Consulta del TRATAMIENTO DEL PACIENTE

    $this->SetFont('Arial','B',10);    
    $this->Text(10,200, utf8_decode('TRATAMIENTO DEL PACIENTE'));
    $this->Ln(50);
...
function Footer()
{
     $this->SetFont('Arial', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("cal y mayor-acosta © Todos los derechos reservados."),0,0,"C");
...
$pdf->Ln();
    ...
    while($raw = $ge->fetch()){
      ...
      $pdf->Cell(40, 20, utf8_decode($raw['fere']),1,0,'L',0);
      $pdf->MultiCell(150,20,utf8_decode($raw['nomtra']),'LRTB','L',false);
    ...
    $pdf->Output('historia_general.pdf', 'D');
 ?>