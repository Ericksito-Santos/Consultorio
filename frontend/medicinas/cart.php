...
<head>
    ...
    <title>Cal y Mayor-acosta | Finalizar pago de medicinas</title>
</head>
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#" class="active"><i class='bx bxs-spray-can icon' ></i> Medicamentos<i class='bx bx-chevron-right icon-right' ></i></a>
                <ul class="side-dropdown">
        ...
        <nav>
            ...
            <form action="#">
                <div class="form-group">
                    <input type="text" placeholder="Buscaar...">
 ...
 if($select_cart->rowCount() > 0){
     ...
     ?>
                    ...
                    <tr>
                        ...
                        <td data-title="Precio">MXN/<?= $fetch_cart['preprd']; ?></td>
                        <td data-title="Stock">	MXN/<?= $fetch_cart['stock']; ?></td>
   ...
   ?>
           ...
           <h1 style="font-size:42px; color:#000000;">Precio Total: 	MXN/<?php echo number_format($grand_total, 2); ?>
